                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="header">
                                    <h4 class="title">Information Of Category</h4>
                                    <p class="category">display the id , name and description for categories.</p>
                                </div>
                                <div class="content table-responsive table-full-width">
                                    <table class="table table-hover table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            $sql_select = "SELECT * FROM category ORDER BY cId";
                                            $result = mysqli_query($conn, $sql_select);

                                            while ($row = mysqli_fetch_array($result)) {
                                                echo '<tr><td>' . $row['cId'] . '</td><td>' . $row['cName'] . '</td><td>' . $row['cDescription'];
                                            }
