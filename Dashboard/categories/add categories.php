                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="description" rows="5" class="form-control"
                                                        placeholder="Here can your write description.."
                                                        value=""></textarea>
                                                </div>
                                            </div>
                                        </div>
...
if (isset($_POST['submit'])) {
    ...
    if ($isFound > 0) {
        ...
        $sql_insert = "INSERT INTO category(cId,cName,cDescription) VALUES ('$id','$name','$description')";

        if (mysqli_query($conn, $sql_insert)) {
            echo "<script type='text/javascript'>
                                alert('Add Category Is Done...');
                            </script>";
        } else {
            echo "<script type='text/javascript'>
                                alert('Add Category Is Fail...');
                            </script>";
        }
    }
}
